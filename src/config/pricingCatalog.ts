...
export const DEFAULT_PRICING_PLANS: DefaultPricingPlan[] = [
  {
    ...
    name: "Individual",
    name_ar: "فردي",
    description: "1 user · 50 GB storage · 14-day free trial",
    description_ar: "١ مستخدم · ٥٠ جيجا تخزين · تجربة مجانية ١٤ يوم",
    visible: true,
    highlighted: true,
    ...
    features: [
      ...
      { name: "Unlimited documents", name_ar: "مستندات غير محدودة", included: true },
  ...
  },
  {
    ...
    name: "Starter",
    name_ar: "البداية",
    description: "5 users min · 250 GB storage · $20 per user/mo",
    description_ar: "٥ مستخدمين كحد أدنى · ٢٥٠ جيجا تخزين · ٢٠ دولار/مستخدم/شهر",
    visible: true,
    highlighted: false,
  ...
  },
  {
    ...
    description: "10 users min · 1 TB storage · $30 per user/mo",
    description_ar: "١٠ مستخدمين كحد أدنى · ١ تيرا تخزين · ٣٠ دولار/مستخدم/شهر",
    visible: true,
    highlighted: false,
  ...
  },
  {
    ...
    description: "20 users min · 2 TB storage · $50 per user/mo",
    description_ar: "٢٠ مستخدمًا كحد أدنى · ٢ تيرا تخزين · ٥٠ دولار/مستخدم/شهر",
    visible: true,
    highlighted: false,
    ...
    features: [
      ...
      { name: "Premium support", name_ar: "دعم مميز", included: true },
    ],
  },
];
