...
export const DEFAULT_TESTIMONIALS: Testimonial[] = [
  ...
  {
    id: "cs-eneo",
    author_name: "Christian Nola Ze",
    author_name_ar: null,
    role: "Chief Information Officer",
    role_ar: "الرئيس التنفيذي لتقنية المعلومات",
    company: "Eneo Cameroon",
    company_ar: "إينيو الكاميرون",
    quote:
      "We manage millions of critical documents, and paper processes slowed us down — retrieval was long and compliance was difficult. Today, Eneo is faster, more secure and fully compliant.",
    quote_ar:
      "ندير ملايين المستندات الحيوية، وكانت العمليات الورقية تبطئنا؛ فالاسترجاع طويل والامتثال صعب. أما اليوم فأصبحت إينيو أسرع وأكثر أمانًا وممتثلة بالكامل.",
    avatar_url: null,
    company_logo_url: null,
    rating: 5,
    featured: true,
